...
Use [Apollo Server Lambda](https://www.apollographql.com/docs/apollo-server/v3/deployment/lambda#setting-up-your-project) with GraphQL subscriptions over WebSocket (AWS API Gateway v2).

With this library you can do:

- same things as with [apollo-server-lambda](https://www.apollographql.com/docs/apollo-server/v3/deployment/lambda#setting-up-your-project) by utiizing AWS API Gateway v1
- [GraphQL subscriptions over WebSocket](https://www.apollographql.com/docs/apollo-server/v3/data/subscriptions/#switching-to-graphql-ws) by utilizing AWS API Gateway v2 and [graphql-ws](https://github.com/enisdenjo/graphql-ws)
...
```console
yarn add aws-lambda-graphql graphql graphql-ws ws
# or
npm install aws-lamda-graphql graphql graphql-ws ws
```
